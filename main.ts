...
namespace PCR { //mi icono de PCR en el desplegable
    ...
    export function denaturation(value: denature, time: pcr_times): void {
        ...
        var tempCelsius: number = 0;
        switch (time) {
            case pcr_times.fifteenseconds:
                thetime = 15000;
                break; //fifteenseconds=15000ms
            case pcr_times.twentyseconds:
                thetime = 20000;
                break;
            case pcr_times.thirtyseconds:
                thetime = 30000;
                break;
            case pcr_times.fortyseconds:
                thetime = 40000;
                break;
            case pcr_times.oneminute:
                thetime = 60000;
                break;
            case pcr_times.twominutes:
                thetime = 2 * 60000;
                break;
            case pcr_times.threeminutes:
                thetime = 3 * 60000;
                break;
            case pcr_times.tenminutes:
                thetime = 10 * 60000;
                break;
        }
        //////TEXT START PCR
        ...
        while (changeblock == 1) {
            start = dat.now(); //number of milliseconds ellapsed since january 1
            ...
            switch (value) {
                case elongate.seventytwo:
                    if (totalmillis <= thetime) {
                        ...
                        fullcycle++;
                        //////TEXT NEW CYCLE
                        String(" CYCLE", 50, 50, 1); //meter un espacio antes de la "S"
