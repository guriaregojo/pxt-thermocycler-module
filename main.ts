...
//1) declarar variables e inicializar la pantalla
...
var fullcycle: number=8;
 ...
 //////TEXT initial denature
 String(" DENATURE",40,50,1); //meter un espacio antes de la "S"
 String("Start initial denature",15,20,1);
 pause(1000); //give time for OLED to initialize
 clear(); //borro todo por si acaso
